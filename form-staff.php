...
if (isset($_GET['idstaff'])) {
    ...
    $staff = $api->getDataById('staffs_tb', $_GET['idstaff']);
}
...
<body>
                ...
                <form action="" id="form_add">
                    ...
                    <div class="p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="<?= (isset($staff)) ? $staff['nama_staff'] : ''; ?>" name="nama_staff" id="nama_staff">
                        </div>
                        <div class="mb-3">
                            <label for="posisi" class="form-label">Posisi</label>
                            <input type="text" class="form-control" value="<?= (isset($staff)) ? $staff['posisi_staff'] : ''; ?>" name="posisi_staff" id="posisi_staff">
                        </div>
                        <div class="mb-3">
                            <label for="foto" class="form-label">Foto</label>
                            <?php if (isset($staff)) : ?>
                                <input type="hidden" name="id_staff" value="<?= $staff['id_staff']; ?>" />
                                <input type="hidden" name="foto_staff" value="<?= $staff['foto_staff']; ?>" />
                                <a href="">(<?= $staff['foto_staff']; ?>)</a>
                            <?php endif; ?>
                            <input class="form-control" type="file" name="foto_staff" id="foto_staff">
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script>
        const BtnAdd = $('#btn_add').click(function(btn) {
            ...
            let EPURL = 'api.php?ep=add_staff';

            <?php if (isset($staff)) : ?>
                EPURL = 'api.php?ep=edit_staff';
            <?php endif; ?>
